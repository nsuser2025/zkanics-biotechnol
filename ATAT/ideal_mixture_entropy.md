...
<u>混合エントロピーを計算で求めることは難しい</u></br>
混合エントロピーは配置の組合せ数に由来する統計量であり, 
単一構造の全エネルギーを与える第一原理計算から直接評価することはできない.
そのため, DFT のみで CALPHAD に必要な自由エネルギーを構築することは困難であり,
実際にはクラスター展開やモンテカルロ法などの統計力学的手法を併用する必要がある.
</span>
