...
+ N_{\rm AB}e_{\rm AB} \\
&= \frac{1}{2}zN_{A}e_{\rm AA} + \frac{1}{2}zN_{\rm B}e_{\rm BB}
+N_{\rm AB}\biggl\{ e_{\rm AB} - \frac{e_{\rm AA} + e_{\rm BB}}{2}\biggr\} \\
&= \frac{1}{2}zN e_{\rm AA} x_{\rm A} + \frac{1}{2} zN e_{\rm BB} x_{\rm B}
+zN\biggl\{ e_{\rm AB} - \frac{e_{\rm AA} + e_{\rm BB}}{2}\biggr\}x_{\rm A}x_{\rm B} \\
